export const countries = ['United States', 'Brazil', 'Spain', 'Egypt', 'New Zealand', 'Bahamas',
    ...
    'Iraq', 'Czech Republic', 'Cyprus'].sort();

export const questions = [
    "I  often  notice  small  sounds  when  others  do not",
    "I   usually   concentrate   more   on   the   wholepicture, rather than the small details",
    "I find it easy to do more than one thing at once",
    "If there is an interruption, I can switch back to what I was doing very quickly",
    "I find it easy to ‘read between the lines’ whensomeone is talking to me",
    "I know how to tell if someone listening to me is getting bored",
    "When I’m reading a story I find it difficult towork out the characters’ intentions",
